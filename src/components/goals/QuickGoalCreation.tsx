...
import { CreateGoalData, Goal } from '@/api/goals';

interface QuickGoalCreationProps {
  onGoalCreate: (goalData: Goal) => void;
}
...
export function QuickGoalCreation({ onGoalCreate }: QuickGoalCreationProps) {
  ...
  const handleCreateGoal = () => {
    const goalData: CreateGoalData = {
      ...
      targetAmount: Number(customGoal.targetAmount),
      currentAmount: 0,
      targetDate: customGoal.targetDate?.toISOString(),
      goalType: customGoal.goalType,
      isActive: true,
    };
    onGoalCreate(goalData as unknown as Goal);
  };
        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Pilih dari template yang sudah tersedia atau buat custom
            </p>
          </div>
              ...
              return (
                ...
                >
                  <CardContent className="p-4 text-center">
                    <div
                      className={`w-12 h-12 mx-auto mb-3 rounded-full ${template.color} flex items-center justify-center`}
                    >
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setCustomGoal((prev) => ({ ...prev, name: e.target.value }))
                }
              />
            </div>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setCustomGoal((prev) => ({ ...prev, goalType: value }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
      ...
      {step === 'details' && (
        <div className="space-y-4">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {customGoal.targetDate
                      ? format(customGoal.targetDate, 'PPP')
                      : 'Pilih tanggal'}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={(date) =>
                      setCustomGoal((prev) => ({ ...prev, targetDate: date }))
                    }
                    initialFocus
                  />
                </PopoverContent>
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleCreateGoal}>Buat Goal</Button>
          </div>
        </div>
      )}
    </div>
